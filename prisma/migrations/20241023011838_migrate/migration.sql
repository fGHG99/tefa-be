...
CREATE TABLE `Toko` (
    ...
    `tokoType` ENUM('Kantin', 'Hydro', 'Koperasi') NULL,
...
-- AddForeignKey
ALTER TABLE `Toko` ADD CONSTRAINT `Toko_ownerId_fkey` FOREIGN KEY (`ownerId`) REFERENCES `User`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
